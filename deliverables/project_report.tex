...
\item \textbf{Classification:} Accuracy and macro-averaged $F_{1}$
(so the minority \textsc{stress} class is weighted equally).
\end{itemize}
...
\begin{tabular}{@{}lrr@{}}
\toprule
Model & Accuracy & $F_{1}$-macro \\
\midrule
\textbf{Logistic Regression} & \textbf{0.750} & \textbf{0.718} \\
Random Forest                & 0.708 & 0.683 \\
\bottomrule
\end{tabular}
\end{table}
